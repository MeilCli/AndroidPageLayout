...
namespace AndroidPageLayout.App {
    ...
    [Activity(Label = "SimpleVerticalActivity",Theme = "@style/AppTheme")]
    public class SimpleVerticalActivity : AppCompatActivity {

        private const string label = nameof(SimpleVerticalActivity);

        private PageLayout pageLayout;

        public static void Start(Activity activity) {
            var intent = new Intent(activity,typeof(SimpleVerticalActivity));
        ...
        protected override void OnCreate(Bundle savedInstanceState) {
            ...
            SetContentView(Resource.Layout.SimpleVertical);
